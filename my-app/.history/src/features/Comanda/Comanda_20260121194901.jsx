...
export function Comanda() {
  ...
  // READ/RETRIEVE
  useEffect(() => {
    console.log("inside useEffect before fetch user.id: "+user?.id);
    console.log("inside useEffect before fetch user.id: "+`${endpoint}?userId=${user?.id}`);
  ...
  return (
    <>
      ...
      <form onSubmit={handleSubmit}>
        <label htmlFor="title">What do you want to order?</label>{' '}
